...
var fetchLinkedInProfile = function (token) { return __awaiter(void 0, void 0, void 0, function () {
    var res, _a, profile;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, node_fetch_1.default("https://api.linkedin.com/v2/me?projection=(" + [
                    'id',
...
var LinkedInAuthenticator = /** @class */ (function (_super) {
    __extends(LinkedInAuthenticator, _super);
    function LinkedInAuthenticator(options) {
        var _this = _super.call(this, __assign({ consentURL: 'https://www.linkedin.com/oauth/v2/authorization', tokenURL: 'https://www.linkedin.com/oauth/v2/accessToken', scope: [
                'r_emailaddress',
                'r_liteprofile',
                'w_member_social'
            ].join(' ') }, options), {
        ...
        _this.fetchProfile = fetchLinkedInProfile;
        return _this;
    }
