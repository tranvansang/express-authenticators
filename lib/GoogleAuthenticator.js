...
var profilePictureSize = 1024;
var fetchGoogleProfile = function (token, fields) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var res, _a, profile, id, getEmail, primaryMetaFilters, getAvatar, getFirstLast;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2: throw new (_a.apply(OAuthCommon_1.OAuthProfileError, [void 0, _c.sent()]))();
                case 3: return [4 /*yield*/, res.json()];
                case 4:
                    profile = _c.sent();
                    if (!((_b = profile.resourceName) === null || _b === void 0 ? void 0 : _b.startsWith('people/')))
                        throw new OAuthCommon_1.OAuthProfileError('Invalid response from Google People API');
                    id = profile.resourceName.substr('people/'.length);
                    if (!id)
                    ...
                    getEmail = function () {
                        ...
                        for (var _i = 0, _b = [
                            ...
                            var metaFilter = _b[_i];
                            for (var _c = 0, _d = profile.emailAddresses || []; _c < _d.length; _c++) {
                                var email = _d[_c];
                    ...
                    getAvatar = function () {
                        for (var _i = 0, primaryMetaFilters_1 = primaryMetaFilters; _i < primaryMetaFilters_1.length; _i++) {
                            var metaFilter = primaryMetaFilters_1[_i];
                            for (var _a = 0, _b = profile.photos || []; _a < _b.length; _a++) {
                                var photo = _b[_a];
                    ...
                    getFirstLast = function () {
                        for (var _i = 0, primaryMetaFilters_2 = primaryMetaFilters; _i < primaryMetaFilters_2.length; _i++) {
                            var metaFilter = primaryMetaFilters_2[_i];
                            for (var _a = 0, _b = profile.names || []; _a < _b.length; _a++) {
                                var name = _b[_a];
                        ...
                        for (var _c = 0, primaryMetaFilters_3 = primaryMetaFilters; _c < primaryMetaFilters_3.length; _c++) {
                            var metaFilter = primaryMetaFilters_3[_c];
                            for (var _d = 0, _e = profile.nicknames || []; _d < _e.length; _d++) {
                                var nickname = _e[_d];
                    ...
                    return [2 /*return*/, __assign(__assign(__assign(__assign({ id: id }, getEmail()), { avatar: getAvatar() }), getFirstLast()), { raw: profile })];
            }
        });
    });
};
var GoogleAuthenticator = /** @class */ (function (_super) {
