...
var profilePictureWidth = 1024; //px
var fetchFacebookProfile = function (token, fields) {
...
var FacebookAuthenticator = /** @class */ (function (_super) {
    ...
    function FacebookAuthenticator(options) {
        ...
        _this.fetchProfile = fetchFacebookProfile;
        return _this;
    }
